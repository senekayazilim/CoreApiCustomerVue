...
export interface ProxySignStepOneCadesMobileCoreRequestV4 {
    /**
     * <summary>
...
export interface ProxySignStepOneCoreForCadesMobileResultV4 {
    /**
     * <summary>
     * İşlemin başarıyla tamamlanıp tamamlanmadığını gösterir
     * </summary>
...
export interface ProxySignStepOnePadesMobileCoreRequestV4 {
    /**
     * <summary>
...
export interface ProxySignStepOneCoreForPadesMobileResultV4 {
    /**
     * <summary>
     * İşlemin başarıyla tamamlanıp tamamlanmadığını gösterir
     * </summary>
...
export interface ProxySignStepOneXadesMobileCoreRequestV4 {
    /**
     * <summary>
     * Daha önce yüklenmiş dosyanın OperationId'sidir.
     * </summary>
...
export interface ProxySignStepOneCoreForXadesMobileResultV4 {
    /**
     * <summary>
     * İşlemin başarıyla tamamlanıp tamamlanmadığını gösterir
     * </summary>
...
export interface ProxyVerifyCadesCoreRequestV4 {
    /**
     * <summary>
     * Daha önce yüklenmiş dosyanın OperationId'sidir.
     * </summary>
...
export interface ProxyVerifyCadesCoreResultV4 {
    operationId: string;
    validationResult: ProxyJavaValidationResultV4;
    error: string;
}



export interface ProxyVerifyPadesCoreRequestV4 {
    /**
     * <summary>
     * Daha önce yüklenmiş dosyanın OperationId'sidir.
     * </summary>
...
export interface ProxyVerifyPadesCoreResultV4 {
    operationId: string;
    validationResult: ProxyJavaValidationResultV4;
    error: string;
}
...
export interface ProxyVerifyXadesCoreRequestV4 {
    /**
     * <summary>
     * Daha önce yüklenmiş dosyanın OperationId'sidir.
     * </summary>
...
export interface ProxyVerifyXadesCoreResultV4 {
    operationId: string;
    validationResult: ProxyJavaValidationResultV4;
    error: string;
}
...
export interface ProxyJavaValidationResultV4 {
    signatureValidations: ProxySignatureValidationItemV4[];
    /**
     * <summary>
...
export interface ProxySignatureValidationItemV4 {
    isExpanded: boolean;
    ...
    timestamp: ProxyTimestampValidationItemV4;
    ...
    counterSignatureValidations: ProxySignatureValidationItemV4[];
}



export interface ProxyTimestampValidationItemV4 {
...
// Generated by xxx.ps1 on 2026-03-25 18:34:36
...
export enum SignatureLevelForCadesV4 {
    ...
    C = 4,
    // [Obsolete("X (ES-X) seviyesi desteklenmiyor. XL veya A kullanın.")]
    // [Description("ES-X - Not Supported")]
    X = 5,
